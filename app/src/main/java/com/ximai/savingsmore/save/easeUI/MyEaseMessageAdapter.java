 ...
 */
public class MyEaseMessageAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ImageView header = (ImageView) ((EaseChatRow) convertView).findViewById(com.easemob.easeui.R.id.iv_userhead);
...
//                else {
//                    try {
//                        MyImageLoader.displayRoundCornerImage(message.getStringAttribute("avatar"), header,8, true);
