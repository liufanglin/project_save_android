...
import com.ximai.savingsmore.save.modle.MyDistanceUtil;
...
public class NativeDialog extends Dialog {
    ...
    private String msg_default = "您的手机中没有安装地图导航工具,我们任建议您下载百度或高德地图进行导航";
	...
	private void setMsgDialog() {
    	...
    	if (apps!=null && apps.size()!=0) {
    		mView = LayoutInflater.from(getContext()).inflate(R.layout.view_set_icon_popwindow, null);
...
//    		for (AppInfo app : apps) {
            ...
            Toast.makeText(context,"您手机上还没有安装导航App,请到应用市场下载",Toast.LENGTH_SHORT).show();
